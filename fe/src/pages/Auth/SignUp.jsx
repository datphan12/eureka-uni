...
const SignUp = () => {
    const { signUp, loginWithGoogle, loginWithFacebook } = useAuthStore();
    ...
    const onSubmit = async (data) => {
        try {
            ...
            if (res.success) {
                // toast.success("Vui lòng kiểm tra email để kích hoạt tài khoản!", { autoClose: 4000 });
    ...
    return (
        ...
        >
            ...
            {/* popup SignUp */}
            <div className="flex flex-col gap-y-2 w-[95%] sm:w-[600px] lg:w-[600px] bg-white sm:border border-[#ccc] absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] rounded-2xl p-4 sm:py-4 sm:px-10">
                <p className="text-xl sm:text-[26px] font-bold text-center">Chào mừng đến Eureka Uni!</p>
                <div className="flex-center">
                    <img src={logo_eureka_uni} alt="logo" />
                </div>
                <p className="text-lg sm:text-2xl font-bold text-center">Đăng ký</p>
                    ...
                    <div className="flex flex-col gap-y-1">
                        ...
                        <div className="flex flex-col mb-2">
                            <input
                                ...
                                className="border border-[#ccc] rounded-3xl py-2 px-4"
                            />
                            {errors.hoTen && <ErrorMessage value={errors.hoTen.message} />}
                        </div>
                    </div>
                    <div className="flex flex-col gap-y-1">
                ...
                <div className="text-center mt-2 text-sm sm:text-base">
                    <p>
                        Bạn đã có tài khoản?{" "}
                        <span onClick={() => navigate("/dang-nhap")} className="underline text-primary cursor-pointer">
                            Đăng nhập
                        </span>
                    </p>
                ...
                <div className="flex flex-col gap-y-3 mt-2 text-sm sm:text-base">
                    <button
